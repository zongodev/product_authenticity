                                ...
                                child: IconButton(
                                    onPressed: () {
                                      productController
                                          ...
                                          productController.searchedProduct[index]
                                              .productName!;
                                      ...
                                      productController
                                          ...
                                          productController.searchedProduct[index]
                                              .description!;
                                      productController.imageUrl.value=productController.searchedProduct[index].imageUrl!;
                                      productController.productId.value=productController.searchedProduct[index].productId!;
                                      Get.dialog(
                                        UpdateDialog(
                                          size: size,
                                          index: index,
                                          onPress: () async {
                                            ...
                                            log("test the log $index");
                                            log("uid: ${productController.searchedProduct[index].uid}");
                                            log("category: ${productController.searchedProduct[index].category}");
                                            log("imageUrl: ${productController.searchedProduct[index].imageUrl}");
                                            log("description: ${productController.searchedProduct[index].description}");
                                            log("productId: ${productController.searchedProduct[index].productId}");
                                           await productController.updateProduct(productController.searchedProduct[index].uid!);
                                          },
                                        ),
                                      );
                                    },
